...
if (year=="2017" and SN=="S"):
	...
	trig_A = "HLT_DoubleMu4_3_Jpsi_Displaced"
	trig_B = "HLT_DoubleMu4_Jpsi_NoVertexing"
	L1_seed = "(L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4 || L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4)"
elif (year=="2018" and SN=="S"):
	trig_A = "HLT_Dimuon0_Jpsi"
	trig_B = "HLT_Dimuon0_Jpsi_NoVertexing"
	L1_seed = "1" #take everything
elif (year=="2018" and SN=="N"):
	trig_A = "HLT_DoubleMu4_3_Jpsi"
	trig_B = "HLT_DoubleMu4_Jpsi_NoVertexing"
	L1_seed = "(L1_DoubleMu0er1p5_SQ_OS_dR_Max1p4 || L1_DoubleMu0er1p4_SQ_OS_dR_Max1p4)"
...
f_buffer.cd()
matching_cut_jpsi = "abs(mm_gen_pdgId[0])==443 && abs(mm_gen_mu1_pdgId[0])==13 && abs(mm_gen_mu2_pdgId[0])==13 && (mm_gen_mu1_pdgId[0]*mm_gen_mu2_pdgId[0])<0"
matching_cut_jpsik = matching_cut_jpsi+" && bkmm_gen_pdgId[0]"
...
if SN=="N": chain_matched_L1 = chain_matched.CopyTree(L1_seed)
...
for event in chain_matched_L1:
		...
		if len(event.bkmm_mm_index)>0 and abs(event.bkmm_gen_pdgId[0])==521: #selecting real b2jpsik events
